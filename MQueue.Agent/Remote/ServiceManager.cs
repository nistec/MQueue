        ...
        private void InternalStart()
        {
            try
            {
                ...
                if (AgentManager.Settings.EnablePipeProducer)
                {
                    ...
                    QLogger.Info("PipeServerChannel Producer started... at: " + m_PipeServerProducer.PipeName);
                }
                ...
                if (AgentManager.Settings.EnablePipeConsumer)
                {
                    ...
                    QLogger.Info("PipeServerListener Consumer started... at: " + m_PipeServerConsumer.PipeName);
                }
                ...
                if (AgentManager.Settings.EnableTcpProducer)
                {
                    ...
                    QLogger.Info("TcpServerChannel Producer started... at: " + m_TcpServerProducer.Settings.RawHostAddress);
                }
                if (AgentManager.Settings.EnableTcpConsumer)
                {
                    ...
                    QLogger.Info("TcpServerListener Consumer started... at: " + m_TcpServerConsumer.Settings.RawHostAddress);
                }
                if (AgentManager.Settings.EnableHttpProducer)
                {
                    ...
                    QLogger.Info("HttpServerChannel Producer started... at: " + m_HttpServerProducer.Settings.RawHostAddress);
                }
                if (AgentManager.Settings.EnableHttpConsumer)
                {
                    ...
                    QLogger.Info("HttpServerListener Consumer started... at: " + m_HttpServerConsumer.Settings.RawHostAddress);
                }
                ...
                if (AgentManager.Settings.EnablePipeQueueManager)
                {
                    ...
                    QLogger.Info("ServerQueueManager Manager started... at: " + m_PipeServerQueueManager.PipeName);
                }
                if (AgentManager.Settings.EnableTcpQueueManager)
                {
                    ...
                    QLogger.Info("ServerQueueManager Manager started... at: " + m_TcpServerQueueManager.Settings.RawHostAddress);
                }
