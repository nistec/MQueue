    ...
    public class RemoteChannel : RemoteQueue, IRemoteChannel
    {
        ...
        public void StartAsyncQueue()
        {
            ...
            try
            {
                ...
                {
                    mainThreads.StartThreadPool(new ParameterizedThreadStart(MessageQueueListner));//, MaxThread);
                }
                else
                {
                    mainThreads.StartThreadPool(new ParameterizedThreadStart(AfterReceiveCompleted));//, MaxThread);
                }
       ...
       /// <param name="state"></param>
        ...
        /// </summary>
        private void MessageQueueListner(object state)
        {
