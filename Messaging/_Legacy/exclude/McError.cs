    ...
    internal class McError
    {
        ...
        public static void DumpError(string virtualServer, string errorText)
        {
            try
            {
                ...
                if (File.Exists(IoHelper.PathFix(m_Path + "Settings\\Events.xml")))
                {
                    ds.ReadXml(IoHelper.PathFix(m_Path + "Settings\\Events.xml"));
                }
                ...
                ds.WriteXml(IoHelper.PathFix(m_Path + "Settings\\Events.xml"));
            }
            catch
            {
            }
