...
namespace Nistec.Messaging.Remote
{
    ...
    public class RemoteChannelManager : NetUtils,IDisposable
    {
        ...
        public void StartAsyncManager()
        {
            ...
            {
                ch.StartAsyncQueue();
                //ch.MessageHandler += new MControl.Util.MessageEventHandler(RemoteChannelManager_MessageHandler);
                //ch.ErrorOcurred += new MControl.Util.ErrorOcurredEventHandler(RemoteChannelManager_ErrorOcurred);
                System.Threading.Thread.Sleep(20);
            }
