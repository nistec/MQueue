...
{
    public interface IPrioritySequenceGQueue
    {
        ...
        */
        ...
        /// </summary>
        /// <returns></returns>
        IQueueMessage Dequeue(Guid ptr);
        ...
        IQueueMessage RemoveItem(Guid ptr);

        bool ItemExists(Guid ptr);

        #endregion
    }

    public abstract class PrioritySequenceGQueue : /*ITransScop,*/ IDisposable, IPrioritySequenceGQueue
    {
        //internal static PrioritySequenceGQueue Factory(IQProperties prop)
        //{
        //    switch (prop.Mode)
        //    {
        ...
        private SequenceGQueue normalQ;
        private SequenceGQueue mediumQ;
        private SequenceGQueue highQ;
       ...
       //ConcurrentDictionary<Guid,IQueueMessage> TransactionalItems;
        ...
        protected virtual void OnErrorOccured(QueueItemEventArgs e)
        {
            if (ErrorOccured != null)
                ErrorOccured(this, e);
            Logger.Error("PrioritySequenceGQueue OnError ", e.Message);
        }
        */
        protected virtual void OnTryAdd(Guid ptr, IQueueMessage item, bool result)
        {
            if (item != null)
                Logger.Debug("OnTryAdd {0} item:{1}", result, item.Print());
        }
        protected virtual void OnTryDequeue(Guid ptr, IQueueMessage item, bool result)
        {
            if (item != null)
                Logger.Debug("TryDequeue {0} item:{1}", result, item.Print());
        }
        protected virtual void OnTryPeek(Guid ptr, IQueueMessage item, bool result)
        {
            if (item != null)
        ...
        protected abstract bool TryAdd(Guid identifier, IQueueMessage item);

        protected abstract bool TryDequeue(Guid identifier, out IQueueMessage item);

        protected abstract bool TryPeek(Guid identifier, out IQueueMessage item);
        ...
        */
        public abstract bool ItemExists(Guid ptr);
        ...
        public PrioritySequenceGQueue(string name,int consumeInterval=100)
        {
            ConsumeInterval = Math.Max(consumeInterval,10);
            this.Name = name;
            this.isTrans = false;
            normalQ = new SequenceGQueue();
            mediumQ = new SequenceGQueue();
            highQ = new SequenceGQueue();
        ...
        //internal PrioritySequenceGQueue(string host)
        //{
        //    this.host = host;
        ...
        */
        ...
        {
            private PrioritySequenceGQueue owner;
            ...
            public TransScop(PrioritySequenceGQueue owner,IQueueMessage item)
            {
        ...
        */
        ...
        public virtual void Clear()
        {
            ...
            ClearItems();
            Logger.Info("PrioritySequenceGQueue Cleared");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IQueueMessage Peek(Guid ptr)
        {
        ...
        */
        ...
        /// </summary>
        /// <returns></returns>
        public virtual IQueueMessage Dequeue(Guid ptr)
        {
            IQueueMessage item = null;
            try
            {
                if (TryDequeue(ptr, out item))
                {
                    ...
                    if (item != null)
                        Logger.Info("PrioritySequenceGQueue Dequeue Guid ", item.Print());
                    return item;
                }
            ...
            {
                Logger.Exception("PrioritySequenceGQueue Dequeue Guid error ", tex);
            }
            catch (Exception ex)
            {
                Logger.Exception("PrioritySequenceGQueue Dequeue Guid error ", ex);
            }
        ...
        public virtual IQueueMessage Dequeue(Priority priority)
        {
            ...
            try
            {
                ...
                DequeueScopEvent(item);
                if (item != null)
                    Logger.Info("PrioritySequenceGQueue Dequeue Priority ", item.Print());
            }
            catch (Exception ex)
            {
                Logger.Exception("PrioritySequenceGQueue Dequeue error ", ex);
            }
        ...
        public virtual bool TryDequeue(out IQueueMessage item)
        {
            ...
            try
            {
                ...
                if (item != null)
                    Logger.Info("PrioritySequenceGQueue TryDequeue ", item.Print());
        ...
        public virtual IQueueMessage Dequeue()
        {
            ...
            try
            {
                ...
                DequeueScopEvent(item);
                if (item != null)
                    Logger.Info("PrioritySequenceGQueue Dequeue ", item.Print());
            }
            catch (Exception ex)
            {
                Logger.Exception("PrioritySequenceGQueue Dequeue error ", ex);
        ...
        public virtual IQueueMessage Consume(int maxSecondWait)
        {
            ...
            try
            {
                ...
                DequeueScopEvent(item);
                if (item != null)
                    Logger.Info("PrioritySequenceGQueue Consume ", item.Print());
            }
            catch (Exception ex)
            {
                Logger.Exception("PrioritySequenceGQueue Consume error ", ex);
            }
        ...
        */
        ...
        public virtual IQueueAck Enqueue(IQueueMessage item)
        {
            ...
            //Guid ptr = new Guid(item, Host);
             Guid ptr = new Guid(item.Identifier);
            ...
            if (TryAdd(ptr, item))
            {
                ...
                */
                if (item != null)
                    Logger.Info("PrioritySequenceGQueue Enqueue ", item.Print());
                return new QueueAck(MessageState.Arrived, item);// new Guid(ptr, PtrState.Arrived);
            }
            if (item != null)
                Logger.Error("PrioritySequenceGQueue FailedEnqueue ", item.Print());
            //}
        ...
        public virtual IQueueAck Requeue(IQueueMessage item)
        {
            ...
            if (!ItemExists(ptr))
            {
                ...
                {
                    if (item != null)
                        Logger.Error("PrioritySequenceGQueue Requeue FailedEnqueue ", item.Print());
                    return new QueueAck(MessageState.FailedEnqueue, item);
                }
            }
            if (item != null)
                Logger.Info("PrioritySequenceGQueue Requeue ", item.Print());
        ...
        /// </summary>
        /// <param name="ptr"></param>
        public virtual IQueueMessage RemoveItem(Guid ptr)
        {
            IQueueMessage item;
