...
namespace Nistec.Messaging
{
    ...
    public class GPtrQueue : GQueue<Ptr>
    {
        ...
        /// <summary>
        /// GPtrQueue Ctor with queue name
        /// </summary>
        /// <param name="name"></param>
        public GPtrQueue(string name)
        {
            queueName = name;
            //queue = new ConcurrentQueue<Ptr>();
        }
        ...
        */
        ...
        public bool TryPeek(out Ptr ptr)
        {
            Ptr temp = base.Peek();
            if (!temp.IsEmpty)
            {
            ...
            /// </summary>
            /// <returns></returns>
         public new Ptr Dequeue()
        {
            Ptr ptr = base.Dequeue(); 
        ...
        public bool TryDequeue(out Ptr ptr)
        {
            Ptr temp = base.Dequeue();
            if (!temp.IsEmpty)
            {
                Ptr copy = temp.Copy();
                temp.Dispose();
        ...
        public new void Enqueue(Ptr ptr)
        {
            ...
            //w.Stop();
            //Console.WriteLine("GPtrQueue ElapsedMilliseconds:{0}", w.ElapsedMilliseconds);
        }
        */
        /// <summary>
