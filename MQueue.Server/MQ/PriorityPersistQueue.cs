...
namespace Nistec.Messaging
{
    ...
    public sealed class PriorityPersistQueue : PriorityQueue
    {
        ...
        public override bool ItemExists(Ptr ptr)
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.Error("PriorityPersistQueue ItemExists : Host:{0}, message:{1}", this.Name, ex.Message);
    ...
    #region members
        ...
        PersistentBinary<IQueueMessage> m_db;
        ConcurrentDictionary<Ptr, IQueueMessage> QueueList;
    ...
    #region ctor
            ...
            : base(qp.QueueName)
        {
            ...
            QueueList = new ConcurrentDictionary<Ptr, IQueueMessage>(concurrencyLevel, initialCapacity);
